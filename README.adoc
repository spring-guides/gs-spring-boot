[![Test, Build, and Deploy to GKE](https://github.com/xihu-infosys/gs-spring-boot-forked/actions/workflows/gcp-j8s-cicd.yml/badge.svg)](https://github.com/xihu-infosys/gs-spring-boot-forked/actions/workflows/gcp-j8s-cicd.yml)
